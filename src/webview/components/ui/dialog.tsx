...
import { cn } from "../../lib/utils"; // パスを ../../lib/utils に修正
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn(
      // ▼▼▼ 変更: backdrop-blur-sm を削除し、色を bg-black/50 に変更 ▼▼▼
